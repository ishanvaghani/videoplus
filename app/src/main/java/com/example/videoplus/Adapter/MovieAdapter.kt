...
class MovieAdapter(private var mContext: Context, private var movies: ArrayList<Movie>) : RecyclerView.Adapter<MovieAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val movieImage: ImageView = itemView.findViewById(R.id.movieImage_movieItem)
    }
}